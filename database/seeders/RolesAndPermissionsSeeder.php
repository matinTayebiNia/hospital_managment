...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Role::firstOrCreate(['name' => 'admin', "as_name" => "ادمین"])
            ->givePermissionTo(['create-sales', 'view-sales', 'view-report', 'create-invoice', 'view-invoice']);

        Role::firstOrCreate(['name' => 'doctor', "as_name" => "دکتر"])
            ->givePermissionTo(['doctor-module-control', 'create-prescription', 'view-patient',
                'view-report', 'create-invoice',
                'view-invoice']);

        Role::firstOrCreate(['name' => 'nurse', "as_name" => "پرستار"])
            ->givePermissionTo(['create-sales', 'view-sales',
                'view-report', 'create-invoice',
                'view-invoice']);

        Role::firstOrCreate(['name' => 'staff', "as_name" => "کارمند"])
            ->givePermissionTo(['create-sales', 'view-sales',
                'view-report', 'create-invoice',
                'view-invoice']);

        Role::firstOrCreate(['name' => 'pharmacies', "as_name" => "داروخانه"])
            ->givePermissionTo(['pharmacy-module-control', 'view-sales',
                'view-report', 'create-invoice',
                'view-invoice']);

        Role::firstOrCreate(['name' => 'accountant', "as_name" => "حسابدار"])
            ->givePermissionTo(['create-sales', 'view-sales',
                'view-report', 'create-invoice',
                'view-invoice']);

        Role::firstOrCreate(['name' => 'sales-person', "as_name" => "فروشنده"])
            ->givePermissionTo(['create-sales', 'view-sales',
                'view-report', 'create-invoice',
                'view-invoice']);

        Role::firstOrCreate(['name' => 'patient', "as_name" => "بیمار"])
            ->givePermissionTo(['create-sales', 'view-sales',
                'view-report', 'create-invoice',
                'view-invoice']);

        Role::firstOrCreate(['name' => 'super-admin', "as_name" => "مدیر عامل"]);
