...
<div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
               data-validate-words="2" name="name" value="{{old("name")}}" placeholder="متین طیبی "
...
<div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <select id="gender" name="gender" required="required"
            ...
            <option value="Male" {{old("gender")=="Male"?"selected":""}}>مذکر</option>
            <option value="Female" {{old("gender")=="Female"?"selected":""}}>مونث</option>
        </select>
    </div>
</div>
<div class="item form-group">
...
<div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input id="age" class="form-control col-md-7 col-xs-12"
               name="age" value="{{old("age")}}" placeholder="سن "
               type="number">
    </div>
</div>
<div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea id="address_1" name="address_1"
                                      class="form-control col-md-7 col-xs-12">{{old("address_1")}}</textarea>
    </div>
</div>
<div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea id="address_2" name="address_2"
                                      class="form-control col-md-7 col-xs-12">{{old("address_2")}}</textarea>
    </div>
</div>
<div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input id="religion" class="form-control col-md-7 col-xs-12"
               name="religion" value="{{old("religion")}}" placeholder="دین"
               type="text">
    </div>
</div>
<div class="item form-group">
...
<div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <select name="permission_id[]" class="form-control col-md-7 col-xs-12 " multiple id="permissions">
